...
import 'package:followchef/models/ingredient.dart';
...
class _OrderPageState extends State<OrderPage> {
  List<Ingredient> orderItems = [
    Ingredient(number: '1', name: 'Spaghetti Aglia Olio', information: '200ml | 234 kcal', price: '16.48'),
    Ingredient(number: '1', name: 'Pizza & Pasta', information: '270ml | 134 kcal', price: '13.57'),
    Ingredient(number: '1', name: 'Sweet lemonade', information: '220ml | 304 kcal', price: '12.48'),
  ];
  @override
              ...
              child: Column(
                ...
                children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[
                                    Text(orderItems[index].name,style: TextStyle(fontWeight: FontWeight.w600),),
                                    SizedBox(height: 8,),
                                    Text(orderItems[index].information,style: TextStyle(fontSize: 12,color: Colors.grey.shade500),),
                                  ],
                                ),
                              ),
                              Text(orderItems[index].price,style: TextStyle(color: Colors.amber,fontSize: 17,fontWeight: FontWeight.bold),),
                            ],
                          ),
                          SizedBox(height: 14,),
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Image.asset('assets/images/mastercard.png',height: 24,width: 24,),
                      SizedBox(width: 8,),
